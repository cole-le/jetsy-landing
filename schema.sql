...
-- Image placements table to track where images are used in projects
...
CREATE INDEX IF NOT EXISTS idx_image_placements_file_path ON image_placements(file_path);
